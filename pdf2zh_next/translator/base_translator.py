...
class BaseTranslator(ABC):
    ...
    def prompt(self, text):
        ...
        user_prompt = f"Translate the following text into {self.lang_out}. Output the translation ONLY. If translation is unnecessary (e.g., proper nouns, code), return the original text. Provide NO explanations or notes. Input text:\n\n{text}"
