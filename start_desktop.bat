@echo off
REM PDF2ZH-Next Desktop Application Startup Script
REM Set working directory to script location
cd /d "%~dp0"

REM Set window title
title PDF2ZH-Next Desktop - PDF Math Translation Tool

echo ========================================
echo   PDF2ZH-Next Desktop Application
echo   Version: 2.5.0
echo ========================================
echo.
...
echo Starting PDF2ZH-Next Desktop Application...
echo Please wait, application is initializing...
echo.

REM Launch Desktop GUI mode (no browser required)
